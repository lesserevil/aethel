...
<!-- SECTION:NOTES:BEGIN -->
UNDERSTANDING: Rapier/WASM selected for browser MVP. Creating: PhysicsAdapter interface, ManifestPhysicsMapping, MinimalPhysicsAdapter (pure-JS tests), RapierPhysicsAdapter (WASM production), deterministic tests, user docs.
<!-- SECTION:NOTES:END -->
